...
class RealTime extends React.PureComponent<any, MapState> {
    ...
    render(): React.ReactNode {
        ...
        const {allTypes, selectedType, selectedLocation, locations, types, path, open, snackbarmsg, selectedDuration, selectedYear, selectedMonth, selectedDay, dateArr, startTime, endTime, isGenerate, nodes} = this.state;
                        ...
                        <div className="row">
                            ...
                            ? types[0].map((type) => 
                                <div className="col-md-4 col-xs-12" style={{ paddingBottom: '20px' }}>
                                    <DataCard sensorType={type} location={selectedLocation} isGenerate={false}/>
                                    <br/>
                                </div> )
                            : <></>}
                        </div>
